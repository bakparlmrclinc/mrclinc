...
/**
 * PD change password schema
 * Used by POST /api/pd/password
 */
export const pdChangePasswordSchema = z.object({
...
export type PDChangePasswordInput = z.infer<typeof pdChangePasswordSchema>;
