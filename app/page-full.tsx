            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                  ...
                  <div 
                    className="absolute bottom-6 left-6 right-6 rounded-xl p-3 shadow-sm border border-gray-100"
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <h3 className="font-semibold text-gray-900">Second Opinion Pathway</h3>
                        <p className="text-sm text-gray-600">For cancer & general surgery patients</p>
                      </div>
                      <Link 
                        href="/services#second-opinion"
                        className="text-sm underline flex items-center gap-1 hover:opacity-80"
                        style={{ color: '#1B4965' }}
                      >
                        Learn More
